...
img_file <- "land_cover_bosnia_2.png"
...
filename <- "3d_land_cover_bosnia-dark_2.png"
getwd()
rayshader::render_highquality(
  filename = filename,
  preview = T,
  light = F,
  environment_light = "/home/adam/SYNC/DP/air_museum_playground_4k.hdr",
  intensity_env = 1,
  rotate_env = 90,
  interactive = F,
  parallel = T,
